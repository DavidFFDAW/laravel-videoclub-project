...
class CatalogController extends Controller
{
    ...
    {
        $msg = 'Página principal de catalogo';
        return view('catalog.index', ['arrayPeliculas' => $this->arrayPeliculas]);
    }
    public function getShow($key)
    {
        $pelicula = $this->arrayPeliculas[$key];
        return view('catalog.show', ['pelicula' => $pelicula]);
    }
    public function getCreate()
    {
        $msg = "Página de creación de un nuevo elemento";
        return view('catalog.create', ['msg' => $msg]);
    }
    public function getEdit($id)
    {
        $msg = "Editar contenido del elemento con id: $id";
        return view('catalog.edit', ['id' => $id, 'msg' => $msg]);
    }
}
